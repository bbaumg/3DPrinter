...
blade_length = 250;      // Length of the blade section to be covered
blade_tip_offset = 0; // Y-coordinate of the tip (relative to center Y=0)
blade_width_start = 23;  // Blade width at the sheath opening (handle end)
blade_thickness_edge = .6; // NEW: Blade thickness near the cutting edge [mm] (Defines INNER cavity)
blade_thickness_spine = 1.3; // NEW: Blade thickness near the spine [mm] (Defines INNER cavity)

// Spine Control Points
spine_point_1_x = 240;
spine_point_2_x = 250;
spine_point_2_y = 15;  // Positive for spine side from center
