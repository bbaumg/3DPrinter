/*
	...
	Knife:		This file will specifically fit:  Hoshanho Loong 7" cleaver
	GitHub:		
...
blade_length = 173;      // Length of the blade section to be covered
blade_width_start = 78;  // Blade width at the sheath opening (handle end)
blade_thickness_edge = 1; // NEW: Blade thickness near the cutting edge [mm] (Defines INNER cavity)
blade_thickness_spine = 2.4; // NEW: Blade thickness near the spine [mm] (Defines INNER cavity)

blade_tip_offset = -34; // Y-coordinate of the tip (relative to center Y=0)
// Edge Control Points
edge_point_1_x = 25;
edge_point_2_x = 140;
edge_point_2_y = 41; // Negative for edge side from center

// Spine Control Points
spine_point_1_x = 160;
spine_point_2_x = 170;
spine_point_2_y = 70;  // Positive for spine side from center

wall_thickness = 1.5;      // Desired wall thickness of the sheath [mm]
clearance = 0.2;         // Space (air gap) between blade and inner wall [mm]

drainage_hole_diameter = 20;       // Diameter of drainage holes [mm]

drainage_hole_spacing = 43; // MODIFIED: Default spacing [mm] between hole centers ALONG THE CENTERLINE PATH. Increased default for clarity.
