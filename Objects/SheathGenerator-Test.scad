...
blade_length = 80;      // Length of the blade section to be covered
blade_tip_offset = 65; // Y-coordinate of the tip (relative to center Y=0)
blade_width_start = 56;  // Blade width at the sheath opening (handle end)
...
spine_point_1_x = 1;
spine_point_2_x = 45;
spine_point_2_y = 55;  // Positive for spine side from center

// Edge Control Points
edge_point_1_x = 1;
edge_point_2_x =64;
edge_point_2_y = -29; // Negative for edge side from center
