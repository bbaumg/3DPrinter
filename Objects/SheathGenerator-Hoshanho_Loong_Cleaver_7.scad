...
blade_length = 183;      // Length of the blade section to be covered
blade_width_start = 76;  // Blade width at the sheath opening (handle end)
...
blade_tip_offset = -16; // Y-coordinate of the tip (relative to center Y=0)
// Edge Control Points
edge_point_1_x = 25;
edge_point_2_x = 129;
edge_point_2_y = 40; // Negative for edge side from center

// Spine Control Points
spine_point_1_x = 150;
spine_point_2_x = 155;
spine_point_2_y = 85;  // Positive for spine side from center
